...
$.extend( $.validator, {
	...
	messages: {
		...
		number: "Ingresa sólo números o decimales.",
		otherchar: "Please enter a character.",
		fullname: "Ingresa tu nombre y apellido.",
		digits: "Ingresa sólo números.",
		creditcard: "Ingresa un número de tarjeta válido.",
		equalTo: "Please enter the same value again.",
		maxlength: $.validator.format( "No puedes ingresar más de {0} caracteres." ),
		minlength: $.validator.format( "Debes ingresar al menos {0} caracteres." ),
		rangelength: $.validator.format( "Ingresa un valor entre {0} y {1} caracteres de largo." ),
	...
	methods: {
		...
		// New JBM
		otherchar: function( value, element ) {
			return this.optional( element ) || /^[ 0-9a-zA-Z\b]+$/.test( value );
		},

		// New JBM
		fullname: function( value, element ) {
			return this.optional( element ) || /^[A-Za-záéíóúñ]{2,}([\s][A-Za-záéíóúñ]{2,})+$/.test( value );
		},
