			...
			<tbody>
				...
				<tr>
					...
					<td class="txt-center">
						...
						<a href="" onclick="window.open('../preview/preview.php?cup_id=<?php echo $cupon['cup_id']; ?>', 'ventana1', 'width=1210,height=600,scrollbars=NO')" class="btn btn-principal btn-small" style="margin-bottom: 10px;"><i class="fa fa-eye"></i> Vista previa</a>

						<a href="" onclick="window.open('../preview/printable.php?cup_id=<?php echo $cupon['cup_id']; ?>', 'ventana1', 'width=1080,height=600,scrollbars=NO')" class="btn btn-principal btn-small" style="margin-bottom: 10px;"><i class="fa fa-picture-o"></i> Imprimible</a>
					</td>
				</tr>
				<?php } ?>
			</tbody>
