<?php
	...
	addCupon($cup_id, $cup_titulo, $cup_descripcion_corta, $cup_descripcion_larga, $cup_legal, $cup_vigencia_inicio, $cup_vigencia_fin, $emp_id, $cat_id, $dep_id, $cup_imagen, $cup_destacado, $cup_estado);
