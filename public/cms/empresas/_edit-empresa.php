<?php
	...
	editEmpresa($emp_id, $emp_nombre, $emp_descripcion, $emp_logo, $emp_direccion, $emp_telefono, $emp_email, $emp_url, $emp_url_2, $emp_mapa, $emp_estado);
	header('Location: empresas-edit.php?emp_id='.$emp_id.'&message=true');
