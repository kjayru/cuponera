                ...
                <section class="section1">
                    <div class="section1__align">
                        <div class="section1__main">
                            <div class="links"><a href="/cupones">< Volver</a></div>
                            <div class="content">
                                <div class="content__header">
                                    ...
                                    <div class="info">
                                        ...
                                        <p>{!! $cupon->cupempresa->emp_direccion !!} <br/>{{ $cupon->cupempresa->emp_telefono }}<br/><a href="{{ $cupon->cupempresa->emp_url }}" target="_blank">{{ $cupon->cupempresa->emp_url }}</a></p>
                                    </div>
                                </div>
                                <div class="content__main">
                                    <div class="buttons">
                                        <button class="button">Descargar Cupón</button>
